...
using Spicey.Data;
using Spicey.Models;
using Spicey.Models.ViewModels;
using Spicey.Utility;
using Stripe;

namespace Spicey.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if(HttpContext.Session.Get(SD.ssCouponCode)!=null)
            {
        ...
        public async Task<IActionResult> SummaryPost(string stripeToken)
        {
            ...
            {
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "Spicey - Order Created " + detailCart.OrderHeader.Id.ToString(), "Order has been submitted successfully");


                detailCart.OrderHeader.PaymentStatus = SD.PaymentStatusApproved;
                detailCart.OrderHeader.Status = SD.StatusSubmited;
            }
            else
            {
                detailCart.OrderHeader.PaymentStatus = SD.PaymentStatusRejected;
