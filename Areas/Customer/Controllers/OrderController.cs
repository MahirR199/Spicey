...
namespace Spicey.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> ManageOrder()
        {
            ...
            List<OrderHeader> OrderHeaderList = await _db.OrderHeader.Where(o => o.Status == SD.StatusSubmited || o.Status == SD.StatusInProcess).OrderByDescending(u => u.PickupTime).ToListAsync();
